...
- **Significance (honest):** per-cohort 95% CIs overlap and no single cohort is individually significant at 5 folds; the pooled paired test across the 25 fold-pairs is significant (mean +3.2 points, t(24)=2.27, p ≈ 0.03, 17/25 folds favor PaRLA). Report this as a modest pooled effect, not a per-cohort win.
